...
public class TCompactProtocol extends TProtocol {
	 ...
	 *            the maximum number of bytes to read for variable-length
	 *            fields.
	 * @deprecated Use constructor specifying both string limit and container
	 *             limit instead
	 */
	@Deprecated
	...
	public TMessage readMessageBegin() throws TException {
		...
		if (protocolId != PROTOCOL_ID) {
			throw new TProtocolException("Expected protocol id " + Integer.toHexString(PROTOCOL_ID) + " but got "
