 ...
 * decorator that allows a Thrift client to communicate with a multiplexing
 * Thrift server, by prepending the service name to the function name during
 * function calls.
 *
 * <p>
 * NOTE: THIS IS NOT USED BY SERVERS. On the server, use
 * {@link org.apache.thrift.TMultiplexedProcessor TMultiplexedProcessor} to
 * handle requests from a multiplexing client.
 *
 * <p>
...
public class TMultiplexedProtocol extends TProtocolDecorator {
	 ...
	 * prepended to the message header so that the multiplexing server can
	 * broker the function call to the proper service.
	 *
	 * @param protocol
	 *            Your communication protocol of choice, e.g.
	 *            <code>TBinaryProtocol</code>.
	 * @param serviceName
	 *            The service name of the service communicating via this
	 *            protocol.
	 */
