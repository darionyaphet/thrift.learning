...
public abstract class TServerTransport implements Closeable {
	...
	public static abstract class AbstractServerTransportArgs<T extends AbstractServerTransportArgs<T>> {
		int backlog = 0; // A value of 0 means the default value will be used
							// (currently set at 50)
		int clientTimeout = 0;
	...
	/**
	 * Optional method implementation. This signals to the server transport that
	 * it should break out of any accept() or listen() that it is currently
