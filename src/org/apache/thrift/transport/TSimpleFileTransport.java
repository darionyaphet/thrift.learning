...
public final class TSimpleFileTransport extends TTransport {
	...
	/**
	 * Create a transport backed by a simple file Implicitly opens file to
	 * conform to C++ behavior.
	 * 
	 * @param path
	 *            the path to the file to open/create
	 * @param read
	...
	/**
	 * Create a transport backed by a simple read only disk file (implicitly
	 * opens file)
	 *
	 * @param path
	 *            the path to the file to open/create
	...
	public void open() throws TTransportException {
		if (file == null) {
			try {
				String access = "r"; // RandomAccessFile objects must be
										// readable
				if (writable) {
					access += "w";
				}
